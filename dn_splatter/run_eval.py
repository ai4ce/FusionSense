...
if __name__ == '__main__':
    ...
    argparser.add_argument('--input_dir', type=str, required=True, help='Path to the input directory.')
    argparser.add_argument('--output_dir', type=str, required=True, help='Path to the output directory.')
    argparser.add_argument('--exp_name', type=str, default='000', help='Experiment planner.')
    argparser.add_argument('--past_n_trials', type=int, default=0, help='Past n trials.')
